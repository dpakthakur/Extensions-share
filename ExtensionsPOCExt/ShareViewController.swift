...
class ShareViewController: SLComposeServiceViewController, ColorSelectionViewControllerDelegate {
    ...
    func showColorSelection() {
        let controller = ColorSelectionTableViewController(style: .plain)
    ...
    func colorSelection(sender: ColorSelectionTableViewController, selectedValue: String) {
    ...
    func saveImage(color: String, imageData: Data) {
